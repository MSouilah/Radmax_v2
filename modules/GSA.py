...
import numpy as np
from numpy import append, ones, zeros, linspace, log10, concatenate, random
b = Calcul4Radmax()
...
def gsa(energy, LimitExceeded, count_cycle, data, args=()):
    a = P4Rm()
    temp = concatenate(
        (a.ParamDict['state_sp'], a.ParamDict['state_dwp']),
        axis=0
    )
