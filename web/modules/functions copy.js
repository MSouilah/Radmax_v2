...
const bootstrap_theme_path = "/css/boostrap.min.css",
    tabulator_theme_path = "/modules/tabulator/5.0.7/css/tabulator_read.min.css",
...
table_strain_dw_values = new Tabulator("#table_strain_dw_values", {
    ...
    resizableRows:false,
    columns:[
        {title:"Index", field:"name", frozen:true, headerSort:false},
        {title:"Depth", field:"x_value", frozen:true, headerSort:false},
        {title:"Strain", field:"strain", frozen:true, headerSort:false, editor:true},
        {
        ...
        {title:"DW", field:"dw", frozen:true, headerSort:false, editor:true},
        {
...
table_database = new Tabulator("#table_database", {
    ...
    columns:[
        ...
        {title:"Date", field:"date", formatter:dateFormatter, sorter:"datetime",
            sorterParams:{
